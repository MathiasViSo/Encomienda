...
from envios.querysets import ClienteQuerySet # Agrega esta importación arriba

class Cliente(models.Model):
    objects = ClienteQuerySet.as_manager() # Agrega esta línea al inicio de la clase
    ...
    class Meta:
        ...
        # Agrégalo dentro de la clase Cliente en clientes/models.py
    @property
